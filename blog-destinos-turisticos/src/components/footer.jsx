      ...
      <footer className="footer">
        <div className="container footer__caption">
            <section className="download">
                ...
                <div className="footer__copy">
                    <p className="copyright">Ana &copy; 2020 Todos los derechos reservados</p>
        ...
        <div className="contact">
            <div className="item__contact">
                ...
                <h3 className="contact__title">Ana Velasquez</h3>
            </div>
            <div className="item__contact">
                <i className='bx bx-mail-send contact__icon' ></i>
                <h3 className="contact__title">hola@gmail.com</h3>
            </div>
            <div className="item__contact">
